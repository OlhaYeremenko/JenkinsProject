...
public class SearchTestRunnerAdvanced extends JUnitStories {
    ...
    CrossReference crossReference = new CrossReference().withJsonOnly().withXmlOnly().withOutputAfterEachStory(true);
    ...
    static{
        System.setProperty("webdriver.chrome.driver","C:\\Users\\Valentyn_Kvasov\\workspace\\Cod\\Cod\\src\\test\\resources\\chromedriver.exe");
       }
    @Override
